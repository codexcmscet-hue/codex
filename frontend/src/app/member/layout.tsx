...
const memberNavItems = [
  ...
  { label: 'Solo Performance', href: '/member/solo-performance', icon: Activity },
  { label: 'My Squad', href: '/member/squad', icon: Code2 },
  { label: 'Club Events', href: '/member/events', icon: Calendar },
  { label: 'Project Blogs', href: '/member/projects', icon: FileCode2 },
        ...
        <div>
          ...
          <Link href="/" className="flex items-center space-x-3 px-3 py-4 mb-6 border-b border-[rgba(0,168,255,0.12)]">
            ...
            <div>
              ...
              <div className="text-[10px] text-zinc-500 font-mono uppercase tracking-widest">DEVELOPER WORKSPACE</div>
              <div className="font-bold text-sm tracking-tight text-white">CodeX<span className="text-[#00a8ff]">Club</span></div>
              <div className="text-[10px] text-[#00a8ff] font-mono uppercase tracking-widest">DEVELOPER WORKSPACE</div>
            </div>
          </Link>
        ...
        <div className="border-t border-[rgba(0,168,255,0.12)] pt-4 space-y-3">
          <div className="flex items-center space-x-3 px-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-zinc-500">Member Portal</div>
              <div className="text-[10px] text-slate-400">Member Portal</div>
            </div>
          </div>
